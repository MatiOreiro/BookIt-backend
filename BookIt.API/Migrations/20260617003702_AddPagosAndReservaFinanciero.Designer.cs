...
namespace BookIt.API.Migrations
{
    ...
    [Migration("20260617003702_AddPagosAndReservaFinanciero")]
    partial class AddPagosAndReservaFinanciero
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookIt.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Nombre = "Admin BookIt",
                            PasswordHash = "$2a$11$hn.kkr7DC451K1DbP8fWWut9QhU9zwhhuXL0ngSIwRdO3ROAHGs/i",
                            Rol = "administrador",
