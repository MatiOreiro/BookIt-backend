...
namespace BookIt.API.Migrations
{
    ...
    [Migration("20260719235138_SeedAllMontevideoBarrios")]
    partial class SeedAllMontevideoBarrios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookIt.API.Models.Pago", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookIt.API.Models.Propuesta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookIt.API.Models.PropuestaServicio", b =>
                {
                    ...
                    b.HasKey("PropuestaId", "ServiceId");

                    b.HasIndex("ServiceId");

                    b.ToTable("PropuestaServicios");
                });

            modelBuilder.Entity("BookIt.API.Models.Resena", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookIt.API.Models.Reserva", b =>
                {
                    ...
                    b.Property<decimal?>("HorasReservadas")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("BookIt.API.Models.SalonService", b =>
                {
                    b.Property<Guid>("SalonId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookIt.API.Models.Service", b =>
                {
                    ...
                    b.Property<string>("DiasAtencionJson")
                        .HasColumnType("text");
                    ...
                    b.Property<int?>("HoraAperturaReserva")
                        .HasColumnType("integer");

                    b.Property<int?>("HoraAperturaVisita")
                        .HasColumnType("integer");

                    b.Property<int?>("HoraCierreReserva")
                        .HasColumnType("integer");

                    b.Property<int?>("HoraCierreVisita")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookIt.API.Models.Pago", b =>
                {
                    b.HasOne("BookIt.API.Models.Reserva", "Reserva")
                        .WithMany("Pagos")
            ...
            modelBuilder.Entity("BookIt.API.Models.Propuesta", b =>
                {
                    b.HasOne("BookIt.API.Models.Service", "Salon")
                        .WithMany()
            ...
            modelBuilder.Entity("BookIt.API.Models.PropuestaServicio", b =>
                {
                    b.HasOne("BookIt.API.Models.Propuesta", "Propuesta")
                        .WithMany("Servicios")
            ...
            modelBuilder.Entity("BookIt.API.Models.Resena", b =>
                {
                    b.HasOne("BookIt.API.Models.Reserva", "Reserva")
                        .WithOne("Resena")
                        .HasForeignKey("BookIt.API.Models.Resena", "ReservaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookIt.API.Models.SalonService", b =>
                {
                    ...
                    b.HasOne("BookIt.API.Models.Service", "Servicio")
                        .WithMany("SalonesQueLoIncluyen")
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookIt.API.Models.Service", b =>
                {
                    ...
                    b.Navigation("SalonesQueLoIncluyen");
